...
Namespace BOMToolsAddIn
    <ProgIdAttribute("BOMToolsAddIn.StandardAddInServer"), _
    ...
    Public Class StandardAddInServer
        ...
        Private WithEvents m_bomToolsButton As ButtonDefinition
...
#Region "ApplicationAddInServer Members"
        ...
        Public Sub Activate(ByVal addInSiteObject As Inventor.ApplicationAddInSite, ByVal firstTime As Boolean) Implements Inventor.ApplicationAddInServer.Activate
            Try
                ...
                m_bomToolsButton = Utilities.CreateButtonDefinition("BOM" & vbCr & "Tools", "BOMToolsGOB", "", "ButtonResources\Icons")
            ...
            Catch ex As Exception
                MsgBox("Unexpected failure in the activation of the add-in ""BOMToolsAddIn""" & vbCrLf & vbCrLf & ex.Message)
            End Try
        End Sub
...
#Region "User interface definition"
        ...
        Private Sub AddToUserInterface()
            ...
            ' Get the "Tools" tab on the part ribbon
            'Dim toolsTab As RibbonTab = partRibbon.RibbonTabs.Item("id_TabTools")

            'get the "Tools" tab on the assembly ribbon
            Dim assyToolsTab As RibbonTab = assemblyRibbon.RibbonTabs.Item("id_TabTools")

            ' Check to see if the "GOB Tools" panel already exists and create it if it doesn't.
            Dim customPanel As RibbonPanel = Nothing
            Try
                'customPanel = toolsTab.RibbonPanels.Item("MySample")
                customPanel = assyToolsTab.RibbonPanels.Item("GOB Tools")
            Catch ex As Exception
            End Try
            ...
            If customPanel Is Nothing Then
                ...
                customPanel = assyToolsTab.RibbonPanels.Add("GOB Tools", "GOBBomTools", g_addInClientID)
            End If

            ' Add a button.
            If Not m_bomToolsButton Is Nothing Then
                customPanel.CommandControls.AddButton(m_bomToolsButton, True)
            End If
        End Sub
        ...
        Private Sub m_sampleButton_OnExecute(Context As NameValueMap) Handles m_bomToolsButton.OnExecute
...
Public Module Globals
    ...
    Public Const g_simpleAddInClientID As String = "7cb5adcc-e7eb-402f-9a05-e6ae7280642c"
