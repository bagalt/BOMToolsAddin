...
#Region "Simplified Button Creation"
    ...
    Public Function CreateButtonDefinition(DisplayName As String,
        ...
        If Not testDef Is Nothing Then
            MsgBox("Error when loading the add-in ""BOMToolsAddIn"". A command already exists with the same internal name. Each add-in must have a unique internal name. Change the internal name in the call to CreateButtonDefinition.", MsgBoxStyle.Exclamation + MsgBoxStyle.OkOnly, "Inventor Add-In Template")
            Return Nothing
        End If
